...
//		10. Comprobar si la primera cifra de un número entero N de 3 cifras es impar
		int numero = 123;
		System.out.println(((int)123/100)%2==0?"Primera cifra par": "Primera cifra impar");
//		11. Comprobar si la primera cifra de un número entero N de 4 cifras es par
		numero = 4321;
		System.out.println(((int)123/1000)%2==0?"Primera cifra par": "Primera cifra impar");
//		12. Comprobar si una variable A de tipo carácter contiene una letra mayúscula
		char caracterA = 'e';
		System.out.println((!Character.isDigit(caracterA) && Character.valueOf(caracterA).toString().toUpperCase().
				equals(Character.valueOf(caracterA).toString()))?"Mayúscula":"O minúscula o no es un carácter");
...
//		14. Comprobar si una variable A de tipo carácter no contiene una letra mayúscula
		System.out.println((!Character.isDigit(caracterA)&& !Character.valueOf(caracterA).toString().toUpperCase().
				equals(Character.valueOf(caracterA).toString()))?"Minúscula":"Mayúscula o no es un carácter");
//		15. Comprobar si una variable A de tipo carácter no contiene una letra mayúscula o minúscula
		...
		System.out.println(codigoCaracter<65 || (codigoCaracter>90 && codigoCaracter<97)
...
//		16. Comprobar si el contenido de la variable N termina en 0 ó en 7
		System.out.println(String.valueOf(numero).endsWith("0") ||
				String.valueOf(numero).endsWith("7")?"El número termina en 0 o 7":
...
//		18. Sumar el dígito más a la derecha de N al propio valor de N. Por ejemplo, si N contiene el valor 463 después de la operación contendrá el valor 466 ( 463 + 3 )
		int ultimoDigito = (int)String.valueOf(numero).charAt(String.valueOf(numero).length()-1);
...
//		19. Comprobar si un número entero N de cuatro cifras es capicúa. Un número es capicúa si se puede leer igual de derecha a izquierda que de izquierda a derecha.
	    System.out.println(String.valueOf(numero).charAt(0)==ultimoDigito &&
	    		String.valueOf(numero).charAt(1)==String.valueOf(numero).charAt(2)?
	    				"Capicúa":"No capicúa");
//		20. Una variable entera M contiene un número de mes. Comprobar si corresponde a un mes de 30 días.
	    ...
	    System.out.println((mes == Month.APRIL.getValue() || 
	    		...
	    		mes == Month.NOVEMBER.getValue())?"Mes con 30 días":"El mes no tiene 30 días");
//		21. Quitarle a un número entero N su última cifra. Supondremos que N tiene más de una cifra. Por ejemplo si N contiene el valor 123 después de la operación contendrá el valor 12.
	    System.out.println(String.valueOf(numero).substring(0,String.valueOf(numero).length()-2));
//		22. Quitarle a un número entero N de 5 cifras su primera cifra. Por ejemplo si N contiene el valor 12345, después de la operación contendrá el valor 2345.
	    System.out.println(String.valueOf(numero).substring(1,String.valueOf(numero).length()-1));
//		23. Comprobar si una variable C de tipo char contiene un dígito. (Carácter entre 0 y 9)
	    char caracterC='2';
	    System.out.println(Character.isDigit(caracterC)?"Contiene un dígito":"No contiene un dígito");
...
//		que compruebe si tiene 18 años cumplidos.
	    ...
	    int mesNac = 2;
	    int anioNac = 1992;
	    System.out.println(Period.between(LocalDate.of(anioActual, mesActual, diaActual), 
