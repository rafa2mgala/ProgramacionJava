...
/**
 * Ejemplo de formateador específico para mensajes de depuración
 * en fichero
 * @author rafa
 * @version 1.0
 */
public class FileFormatter extends Formatter{
	...
	public String format(LogRecord arg0) {
		...
		message = "File Log " + level + LocalDateTime.ofInstant(Instant.ofEpochMilli(arg0.getMillis()),ZoneId.systemDefault()) +
